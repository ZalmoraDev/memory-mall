...
<template>
  <div
    ...
    <div class="os-startmenu-bottom-colors flex justify-end gap-2 p-1 w-full border-t-2 border-os-primary">
      <div class="flex gap-1 items-center">
        <UButton icon="material-symbols:key-outline" size="md" :ui="{leadingIcon: 'text-white'}"
                 class="w-8 h-8 bg-amber-500 hover:bg-amber-600 active:bg-amber-700 border border-os-tertiary inset-shadow-sm inset-shadow-white/75! justify-center">
        </UButton>
      ...
      <div class="flex gap-1 items-center p-1">
        <UButton icon="material-symbols:power-settings-new-outline" size="md" :ui="{leadingIcon: 'text-white'}"
                 class="w-8 h-8 bg-red-500 hover:bg-red-600 active:bg-red-700 border border-os-tertiary inset-shadow-sm inset-shadow-white/75! justify-center">
        </UButton>
